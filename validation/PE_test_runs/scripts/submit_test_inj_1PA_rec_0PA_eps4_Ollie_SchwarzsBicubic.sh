...
#SBATCH -A lp_lisagw
#SBATCH --job-name=test_inj_1PA_rec_0PA_eps4_Ollie_SchwarzsBicubic
...
INFERENCE_PARAMS=$HOME_FOLDER/config/test_inj_1PA_rec_0PA_eps4_Ollie_SchwarzsBicubic.yaml
