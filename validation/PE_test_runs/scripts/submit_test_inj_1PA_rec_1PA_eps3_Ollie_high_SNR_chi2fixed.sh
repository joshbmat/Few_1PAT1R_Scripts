...
#SBATCH -A lp_lisagw
#SBATCH --job-name=test_inj_1PA_rec_1PA_eps3_Ollie_high_SNR_chi2fixed
...
INFERENCE_PARAMS=$HOME_FOLDER/config/test_inj_1PA_rec_1PA_eps3_Ollie_high_SNR_chi2fixed.yaml
